...
function PlaceOrder() {
    ...
    const onSubmitHandler = async () => {
        ...
        try {
            ...
            const orderData = { address: formData, orderItems, amount: getCartAmount() + delivery_fee };
            ...
            if (method === 'cod') {
                ...
                const resrp = await axios.post(serverurl + '/api/order/placeorderrazor', orderData, { withCredentials: true });
                if (resrp.data) initPay(resrp.data);
            }
        } catch (error) {
